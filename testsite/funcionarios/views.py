...
from .forms import FuncionarioForm, OcupacaoForm, PagamentoForm
...
##############################################
#
Views relacionadas com Pagamentos de funcionários.
#
##############################################
"""
"""
...
def pagamento_novo(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            return HttpResponseRedirect(reverse('funcionarios:pagamento_list'))

    else:
        form = PagamentoForm()
    return render(request, 'funcionarios/pagamento/pagamento_novo.html', {'form': form})    
...
def pagamento_list(request):
    ...
    func = funcionario_info()
    context = {'pagamentos': pagamentos,
                'func': func}
    return render(request, 'funcionarios/pagamento/pagamento_list.html', context)
...
def pagamento_edit(request, pk):
    ...
    return render(request, 'funcionarios/pagamento/pagamento_edit.html', context)
