...
from .models import Funcionario, Ocupacao, ValeRefeicao, ValeTransporte
...
class ValeRefeicaoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'valor': forms.NumberInput(attrs={'placeholder': 'Digita o valor mensal do VR', 'class':'form-control'}),
        }
        labels = {
            'nome': 'Identificação',
            'valor': 'Valor',
