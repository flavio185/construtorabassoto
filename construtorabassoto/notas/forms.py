...
class NotaForm(forms.ModelForm):
    ...
    class Meta:
        model = Nota
        widgets = {
            'servico_terceirizado': forms.HiddenInput(),
            'tipo_gasto': forms.Select(attrs={ 'class':'form-control', 'required': 'false'}),
        }

        fields = ['numero', 'data', 'emitente', 'descricao', 'valor', 'tipo_gasto', 'projeto','deposito', 'imagem', 'imagem1', 'servico_terceirizado']
